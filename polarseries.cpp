...
double CPolarSeries::PointToAngle(long X, long Y)
{
	double result;
	static BYTE parms[] =
		VTS_I4 VTS_I4;
...
long CPolarSeries::AddPolar(double Angle, double Value, LPCTSTR ALabel, unsigned long AColor)
{
	long result;
	static BYTE parms[] =
		VTS_R8 VTS_R8 VTS_BSTR VTS_I4;
	InvokeHelper(0x25, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		Angle, Value, ALabel, AColor);
	return result;
}

void CPolarSeries::DrawRing(double Value)
{
	static BYTE parms[] =
		VTS_R8;
