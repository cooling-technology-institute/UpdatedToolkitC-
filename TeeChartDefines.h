...
//Defines file by Kurt Schaeppi
//for use with MS VC++ and TeeChart
// TeeChart constants as taken from the help file
...
// EMouseButton
const unsigned long mbLeft = 0;
const unsigned long mbRight	= 1;
const unsigned long mbMiddle = 2;
...
// EShiftState
const unsigned long ssShift	= 0;
const unsigned long ssAlt = 1;
const unsigned long ssCtrl = 2;
const unsigned long ssLeft = 3;
const unsigned long ssRight	= 4;
