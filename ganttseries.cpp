...
long CGanttSeries::AddGantt(double AStart, double AEnd, double AY, LPCTSTR AXLabel)
{
	long result;
	static BYTE parms[] =
		VTS_R8 VTS_R8 VTS_R8 VTS_BSTR;
	InvokeHelper(0x22, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		AStart, AEnd, AY, AXLabel);
	return result;
}

long CGanttSeries::AddGanttColor(double AStart, double AEnd, double AY, LPCTSTR AXLabel, unsigned long AColor)
{
	long result;
	static BYTE parms[] =
		VTS_R8 VTS_R8 VTS_R8 VTS_BSTR VTS_I4;
	InvokeHelper(0x23, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		AStart, AEnd, AY, AXLabel, AColor);
	return result;
}
