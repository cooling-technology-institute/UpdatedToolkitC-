...
CSeries CTChart::GetSeries(long Index)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
		VTS_I4;
...
long CTChart::CloneSeries(long SeriesIndex)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
double CTChart::GetDateTimeStep(long Step)
{
	double result;
	static BYTE parms[] =
		VTS_I4;
...
unsigned long CTChart::GetFreeSeriesColor(BOOL CheckBackground)
{
...
CSeries CTChart::GetLabelsSeries(long Axis)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
		VTS_I4;
...
BOOL CTChart::IsFreeSeriesColor(unsigned long AColor, BOOL CheckBackground)
{
	BOOL result;
	static BYTE parms[] =
		VTS_I4 VTS_BOOL;
	InvokeHelper(0x24, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
		AColor, CheckBackground);
	return result;
}
...
CString CTChart::SeriesTitleLegend(long SeriesIndex)
{
	CString result;
	static BYTE parms[] =
		VTS_I4;
